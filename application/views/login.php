...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | POS System' . ' | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
	<div id="logo" align="center"><img src="<?php echo base_url();?>/images/logo.jpg"></div>
